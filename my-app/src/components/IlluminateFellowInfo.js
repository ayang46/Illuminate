...
const IlluminateFellowInfo = () => {
    return (
        <div className="IFinfo">
            <div className="section">
                <h1 className="text-4xl flex-wrap font-bold text-center">How to Become an Illuminate Fellow</h1>
